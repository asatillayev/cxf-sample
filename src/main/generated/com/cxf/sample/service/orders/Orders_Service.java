...
public class Orders_Service extends Service {
    ...
    public final static QName SERVICE = new QName("http://sample.cxf.com/service/Orders/", "Orders");
    public final static QName OrdersSOAP = new QName("http://sample.cxf.com/service/Orders/", "OrdersSOAP");
    static {
        URL url = null;
        try {
            url = new URL("file:/D:/projects/webservices/cxf-sample/src/main/resources/wsdl/Orders.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(Orders_Service.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/D:/projects/webservices/cxf-sample/src/main/resources/wsdl/Orders.wsdl");
        }
        WSDL_LOCATION = url;
    }
